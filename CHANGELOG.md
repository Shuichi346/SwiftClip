...
- Changed snippet attachments to copy selected files into SwiftClip's Application Support storage and clean up managed copies when attachments or snippets are deleted.
